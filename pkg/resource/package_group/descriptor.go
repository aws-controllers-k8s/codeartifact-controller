...
const (
	FinalizerString = "finalizers.codeartifact.services.k8s.aws/PackageGroup"
)

var (
	GroupVersionResource = svcapitypes.GroupVersion.WithResource("packagegroups")
...
func (d *resourceDescriptor) EmptyRuntimeObject() rtclient.Object {
	return &svcapitypes.PackageGroup{}
}
...
func (d *resourceDescriptor) ResourceFromRuntimeObject(
	...
	return &resource{
		ko: obj.(*svcapitypes.PackageGroup),
	}
}
