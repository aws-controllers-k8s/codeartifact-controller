...
// +kubebuilder:rbac:groups=codeartifact.services.k8s.aws,resources=domains,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=codeartifact.services.k8s.aws,resources=domains/status,verbs=get;update;patch
