...
func (rm *resourceManager) ResolveReferences(
	...
	if fieldHasReferences, err := rm.resolveReferenceForEncryptionKey(ctx, apiReader, ko); err != nil {
...
func validateReferenceFields(ko *svcapitypes.Domain) error {
	...
	if ko.Spec.EncryptionKeyRef != nil && ko.Spec.EncryptionKey != nil {
		return ackerr.ResourceReferenceAndIDNotSupportedFor("EncryptionKey", "EncryptionKeyRef")
	}
	return nil
}

// resolveReferenceForEncryptionKey reads the resource referenced
// from EncryptionKeyRef field and sets the EncryptionKey
// from referenced resource. Returns a boolean indicating whether a reference
// contains references, or an error
func (rm *resourceManager) resolveReferenceForEncryptionKey(
	ctx context.Context,
	apiReader client.Reader,
	...
	if ko.Spec.EncryptionKeyRef != nil && ko.Spec.EncryptionKeyRef.From != nil {
		...
		ko.Spec.EncryptionKey = (*string)(obj.Status.ACKResourceMetadata.ARN)
	}
